...
- Wall-clock lever: /fast runs this Opus chair at up to ~2.5× output speed (same Opus 4.8 model, premium tokens) — reach for it when latency matters more than token cost, e.g. a long interactive build you're watching.
